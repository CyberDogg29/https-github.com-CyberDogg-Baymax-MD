...
global.mongodb = process.env.MONGODB || "mongodb://localhost:27017/baymax-md";
global.sessionId = stripEnv(process.env.SESSION_ID, "ok");
global.prefa = stripEnv(process.env.PREFIX, "-");
global.packname = stripEnv(process.env.PACKNAME, `BAYMAX-MD Bot`);
global.author = stripEnv(process.env.AUTHOR, "by: Team Baymax");
